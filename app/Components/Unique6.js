...
const UniqueOne = () => {
  ...
  return (
    <div className='flex flex-col   p-8 gap-5 md:p-28 md:flex xl:p-44 md:flex-row md:gap-10 xl:gap-28  '>
        ...
        <div>
            <h1 className='text-[#272626] font-medium  text-xl'>FURNITURE 
 12/07/2020</h1>
        </div>
        <div>
        ...
        <div>
        <div>
              <img className='md:h-[600px] xl:w-[1000px] object-cover md:w-[1300px] xl:h-[800px]' src="https://preview.colorlib.com/theme/archlab/images/work-6.jpg.webp" alt="" />
        </div>
        </div>
    </div>
  )
