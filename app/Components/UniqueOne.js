...
const UniqueOne = () => {
  ...
  return (
    <div className='flex flex-col  p-8 gap-5 md:p-28  md:flex xl:p-44 md:flex-row md:gap-10 xl:gap-28  ' >
        <div>
        <div>
              <img className='md:h-[600px] xl:w-[1000px] md:w-[1300px] xl:h-[800px] object-cover' src="https://preview.colorlib.com/theme/archlab/images/work-2.jpg.webp" alt="" />
        </div>
        </div>
        <div className='md:py-28 xl:py-28 relative' ref={firstRef}>
        <div className='md:flex md:flex-col md:gap-0 '>
        <div>
            <h1 className='text-[#272626] font-medium  text-xl'>EXTERIOR 12/07/2020</h1>
        </div>
        <div>
            <h1 className='text-[#272626] font-medium py-5 text-5xl md:text-6xl'>Geometric Building</h1>
        </div>
        <div>
