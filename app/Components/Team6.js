...
const Team = () => {
  ...
  return (
    <div className='relative w-full hover:text-[#000000]  text-[#ffffff] hover:transition-colors' ref={firstRef}>
        <img src="https://preview.colorlib.com/theme/archlab/images/team-6.jpg.webp" className='w-full object-top object-cover h-96' />
        <div className='absolute top-72 left-6'>
            <h1 className='font-extrabold text-2xl  '>ROBERT
 <br />WILLS</h1>
