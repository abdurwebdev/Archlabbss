...
const Pricing = () => {
  ...
  return (
    <div className='flex space-y-5 flex-col m-auto p-10' ref={priceRef}>
        <div>
            <img className='h-72 object-cover w-full' src="https://preview.colorlib.com/theme/archlab/images/work-1.jpg.webp"/>
        </div>
        ...
        <div>
            <h1 className='text-3xl font-bold'><sup>$</sup>78 <sub>/mos</sub></h1>
        </div>
        <div>
