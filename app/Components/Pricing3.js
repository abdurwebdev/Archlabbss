...
const Pricing = () => {
    ...
    useEffect(() => {
     ...
     gsap.fromTo(el,{y:50,opacity:0},{y:0,opacity:1,delay:0.2,scrollTrigger:{
        trigger:el
     }})
    }, [])
  return (
    <div className='flex space-y-5 flex-col m-auto p-10' ref={priceRef}>
        <div>
            <img className='h-72 object-cover w-full' src="https://preview.colorlib.com/theme/archlab/images/work-3.jpg.webp"/>
        </div>
        ...
        <div>
            <h1 className='text-3xl font-bold'><sup>$</sup>98 <sub>/mos</sub></h1>
        </div>
        <div>
