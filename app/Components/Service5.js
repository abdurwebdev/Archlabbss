...
import { FcBusinessman, FcCalculator, FcFactory } from "react-icons/fc";
  ...
  return (
    <div className='p-16 m-auto'>
        <div className='flex flex-col items-center justify-center gap-3' ref={firstRef}>
                 <FcCalculator className='text-8xl text-[#96BB7C]'/>
                 <h1 className='text-2xl font-medium'>Furniture</h1>
